...
class NetFighter(nn.Module):
    def __init__(self, n_actions):
        ...
        self.conv = nn.Sequential(     # 100 * 100 * 3
            nn.Conv2d(
                in_channels=5,
                out_channels=8,
                kernel_size=5,
        ...
        self.feature_fc = nn.Sequential(
            nn.Linear((25 * 25 * 8 + 16), 64),
            nn.ReLU(),
        )
        self.decision_fc = nn.Linear(64, n_actions)
...
class RLFighter:
    ...
    def learn(self):
        ...
        q_next = self.target_net(s__screen_mem, s__info_mem).detach()  # detach使tensor不能反向传播
