...
if __name__ == "__main__":
    ...
    if not os.path.exists('prerun_data/MASA_VS_SAC/blue'):
        os.makedirs('prerun_data/MASA_VS_SAC/blue')
    if not os.path.exists('prerun_data/MASA_VS_SAC/red'):
        os.makedirs('prerun_data/MASA_VS_SAC/red')
    ...
    if not os.path.exists('prerun_data/MASA_VS_SAC'):
        os.makedirs('prerun_data/MASA_VS_SAC')

    for i in range(len(blue_fighter_models)):
        path = os.path.join('prerun_data', 'MASA_VS_SAC', 'blue', '%d_data.npy' % i)
        blue_fighter_models[i].save_to_file(path)

        path = os.path.join('prerun_data', 'MASA_VS_SAC', 'red', '%d_data.npy' % i)
