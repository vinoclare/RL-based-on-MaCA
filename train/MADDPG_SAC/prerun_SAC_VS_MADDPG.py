...
if __name__ == "__main__":
    ...
    if not os.path.exists('prerun_data/SAC_VS_MADDPG/blue'):
        os.makedirs('prerun_data/SAC_VS_MADDPG/blue')
    if not os.path.exists('prerun_data/SAC_VS_MADDPG/red'):
        os.makedirs('prerun_data/SAC_VS_MADDPG/red')
