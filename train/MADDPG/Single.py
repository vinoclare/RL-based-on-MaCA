...
# 清除tensorboard文件
for file in os.listdir('C:/MaCA/runs/single'):
    path = os.path.join('C:/MaCA/runs/single', file)
    os.remove(path)
...
if __name__ == "__main__":
    ...
    global_step_cnt = 0
    writer = SummaryWriter('runs/single')
    ...
    for x in range(MAX_EPOCH):
        ...
        while True:
            ...
            if step_cnt % 50 == 0:  # 20个step内航向保持一致，只更新攻击类型
            ...
            if env.get_done():
                ...
                blue_fighter_model.learn('model/MADDPG/single', writer)
