...
import torch
from train.MADDPG import MADDPG_Detector as MADDPG
from torch.utils.tensorboard import SummaryWriter

MAP_PATH = 'C:/MaCA/maps/1000_1000_2_10_vs_2_10.map'
...
# 清除tensorboard文件
for file in os.listdir('C:/MaCA/runs/detector'):
    path = os.path.join('C:/MaCA/runs/detector', file)
    os.remove(path)
...
if __name__ == "__main__":
    ...
    writer = SummaryWriter('runs/detector')
    ...
    for x in range(MAX_EPOCH):
        ...
        while True:
            ...
            if env.get_done():
                ...
                blue_fighter_model.learn('model/MADDPG/detector', writer)
